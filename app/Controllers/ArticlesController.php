...
class ArticlesController extends Controller
{
    ...
    public function articleList(){
        ...
        $articleData = new \Helpers\Paginator('6', 'article_data');
        $data['article_data'] = $this->_article->getAllArticlesPaged($articleData->getLimit());
        $articleData->setTotal( $data['article_data'][0]->total );
        $data['pageLinks'] = $articleData->pageLinks();

        View::renderTemplate('header', $data);
        View::render('articles/index', $data);
        View::renderTemplate('footer', $data);
