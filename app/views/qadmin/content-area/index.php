    ...
    <div class="row">
        <div class="col_10 col_12_lg">
            <div class="row">
                ...
                <?php  if($data['contentAreas']){ 
                    foreach ($data['contentAreas'] as $row) { ?>
                        <div class="col_4 col_12_md">
                            <div class="menu-data--item">
                                <div class="col_12">
                                    <div class="menu-name">
                                        <h3><?php echo $row->contentAreaName; ?></h3>
                                    </div>
                                </div>
                                <div class="col_12">
                                    <div class="page-actions">
                                        <a class="page-action--item" href="/qadmin/menu/edit/<?php echo $row->contentAreaId; ?>">Edit</a>
                                        <a class="page-action--item" href="/qadmin/menu/delete/<?php echo $row->contentAreaId; ?>">Delete</a>
                                    </div>
                                </div>
                             </div>
                          </div>
